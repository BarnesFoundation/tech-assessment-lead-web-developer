...
Here we have a codebase meant to simulate powering the backend of an Event Management Platform -- a common part of a horticultural organization such as The Barnes Foundation and institutions like it. 
